...
// calculate dist_ema
  dist_ema = (ema_a*dist_raw) + ((1-ema_a)*dist_ema);
...
// adjust servo position according to the USS read value
  ...
  if(dist_raw < 180.0) {
     ...
     myservo.writeMicroseconds((dist_raw-180.0)*16.4);
  }
  else {
    myservo.writeMicroseconds(_DUTY_MAX);
  }

  //turn on LED if distance is between 180.0 and 360.0
  if(180.0 > dist_raw || dist_raw > 360.0) {
